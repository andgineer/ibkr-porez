...
def test_resolve_month_year_with_month_only_uses_latest_sales_year() -> None:
    sales_entries = [
...
def test_resolve_month_year_with_month_only_uses_latest_dividend_year_when_no_sales() -> None:
...
def test_resolve_month_year_with_month_only_falls_back_to_current_year(monkeypatch) -> None:
    class FakeDatetime:
        @staticmethod
        def now() -> datetime:
