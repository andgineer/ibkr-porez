...
def test_create_app_icon_uses_all_configured_sizes(monkeypatch: pytest.MonkeyPatch) -> None:
    rendered: list[int] = []
...
def test_panel_rect_scales_with_icon_size() -> None:
...
def test_to_y_maps_higher_value_upwards() -> None:
