...
Након инсталације, **IBKR Porez** ће се појавити у Start менију.

---

## За напредне кориснике

Инсталатер такође инсталира команду `ibkr-porez` за терминал
(можда ће бити потребно поново покренути терминал након инсталације).
