...
После установки **IBKR Porez** появится в меню Пуск.

---

## Для продвинутых пользователей

Инсталлятор помимо GUI также устанавливает команду `ibkr-porez` для терминала
(может потребоваться перезапуск терминала после установки).
