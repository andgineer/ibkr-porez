...
В GUI та же возможность доступна в меню **☰** как **Sync from file…**.

> ℹ️ Если нужно только сохранить транзакции без создания деклараций, используйте команду [`import`](#импорт-исторических-данных-import).
