...
Удаляет декларацию и откатывает её влияние на леджер переносов: перенос убытков, который она использовала, возвращается исходным «траншам», а её собственный «транш» признанного убытка (созданный через `assess`) удаляется. Если вы удалили декларацию, чтобы исправить ошибку, затем запустите `sync`, чтобы пересоздать период из сохранённых транзакций.
